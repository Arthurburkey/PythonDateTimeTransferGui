...
from tkinter.filedialog import askopenfilename #added while troubleshooting
import os
import shutil
import time as t
...
def getDailyPath(self):
	dailyPath = tk.filedialog.askdirectory(initialdir = "C:\\", title = "Select your Daily Folder")	
